    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="relative w-full max-w-lg backdrop-blur-md bg-[#1f1f1f57] border border-[#333] rounded-2xl p-8" onClick={e => e.stopPropagation()}>
              <button
                onClick={onClose}
...
const AboutContent = () => (
  <div className="space-y-6 text-center">
    ...
    <div className="space-y-4 text-white/70">
      <p>
        We are explorers of the digital frontier, seeking to unravel the mysteries
        of artificial consciousness and multi-agent systems.
      </p>
      <p>
      ...
      <p>
        Join us as we venture into the unknown, where thought meets code,
        and intelligence emerges from silence.
      </p>
    </div>
  </div>
);
...
const JourneyContent = () => (
  <div className="space-y-6">
    <h2 className="text-3xl font-bold text-white text-center">The Journey Ahead</h2>
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-white/70 ml-4">
          Uncover the potential of multi-agent systems and explore the foundations
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-white/70 text-center">
        Ready to embark on this journey? Let's connect and explore the possibilities together.
      </p>
      <div className="pt-4">
        <button
      ...
      <p className="text-xs text-white/40 text-center pt-4">
        Let's connect on LinkedIn for professional networking and collaboration opportunities.
      </p>
    </div>
  );
};
                ...
                {step === "email" ? (
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">A New Kind of Intelligence</h1>
                      <p className="text-[1.8rem] text-white/70 font-light">Emerging from silence, shaped by thought</p>
                    </div>
