...
def analyze_signals_with_ai(content_collection: List[Dict], query_context: str, signals: Dict) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        content_summary = "\n\n".join([
            ...
            for item in content_collection[:12]  # Max 12 items to prevent token overflow
        ])
        ...
        if response and response.text:
            ...
            signals["signal_confidence"] = float(confidence_data.get("overall_confidence", 0.5))
...
def analyze_competitive_gaps(market_domain: str) -> Dict[str, Any]:
    ...
    try:
        ...
        if all_content:
            print(f"🤖 Analyzing competitive gaps with AI...")
...
def analyze_competitive_gaps_with_ai(content_collection: List[Dict], market_domain: str, gaps: Dict) -> Dict[str, Any]:
    """
